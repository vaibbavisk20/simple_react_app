...
$populatesqlArguments = "populate_sql.py",
  "--sqlconnectionstring", "`"Driver={ODBC Driver 18 for SQL Server};Server=tcp:sql-cydxse7pimuiu.database.windows.net,1433;Database=sqldb-cydxse7pimuiu;UiD=b4cd9374-b9fc-4635-9560-e56f565c4903;Encrypt=yes;Connection Timeout=30;Authentication=ActiveDirectoryIntegrated`"",

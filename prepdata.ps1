...
$populatesqlArguments = "populate_sql.py",
  "--sqlconnectionstring", "`"Driver={ODBC Driver 18 for SQL Server};Server=tcp:vskSqlServer-1.database.windows.net,1433;Database=vskSqlDatabase-1;Encrypt=yes;Connection Timeout=30;Authentication=ActiveDirectoryIntegrated`"",
